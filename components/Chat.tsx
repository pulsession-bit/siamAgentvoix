                  ...
                  <div className="mt-4 flex flex-wrap gap-2 animate-in fade-in slide-in-from-bottom-2">
                    {msg.suggestedReplies.map((reply, idx) => (
                      <button
                        ...
                        className="px-4 py-2 bg-brand-amber text-brand-navy rounded-xl text-sm font-bold shadow-md hover:bg-white hover:text-brand-amber border border-brand-amber transition-all active:scale-95"
                      >
                        {reply}
                      </button>
                    ))}
